...
from src.models.generators.modified_stable_diffusion import ModifiedStableDiffusionPipeline
...
class InversableStableDiffusionPipeline(ModifiedStableDiffusionPipeline):
    ...
    def get_random_latents(self, latents=None, height=512, width=512, generator=None, batch_size=1):
